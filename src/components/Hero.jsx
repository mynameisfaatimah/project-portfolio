...
const Hero = () => {
  return (
    <div className='relative grid sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8 overflow-hidden' id='hero'>
     ...
     <img className='hidden md:block absolute z-[-1] w-[500px] bottom-[-90] left-[-140px]' src={notebookL} alt=""/>  
     <img className='absolute z-[-1] w-[400px] bottom-[-40px] left-[210px]' src={notebookM} alt=""/>
     <img className='absolute z-[-1] w-[250px] bottom-[200px] md:bottom-[280px] left-[390px]' src={mobileR} alt=""/>

     <div className='glass px-5 cols-span-2 my-auto z-[-1]'>
...
<div className='absolute bottom-0 right-0 w-[160px] lg:w-[600px]' >
